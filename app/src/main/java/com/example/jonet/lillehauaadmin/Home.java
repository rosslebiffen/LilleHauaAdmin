...
import com.example.jonet.lillehauaadmin.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token,true); //False because client side Token
    ...
    private void loadMenu() {
        ...
        adapter.notifyDataSetChanged(); // Refresh if data changes
    ...
    private void showUpdateFoodDialog(final String key, final Category item) {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Add new Category");
        alertDialog.setMessage("Please fill full information");
